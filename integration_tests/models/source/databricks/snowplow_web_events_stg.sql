...
with prep as (
    select
        *,
        from_json(contexts_com_fueledanalytics_fueled_web_page_1_0_0, 'array<struct<id:string>>') as contexts_com_fueledanalytics_fueled_web_page_1,
        from_json(unstruct_event_com_fueledanalytics_fueled_consent_preferences_1_0_0, 'array<struct<basis_for_processing:string, consent_scopes:array<string>, consent_url:string, consent_version:string, domains_applied:array<string>, event_type:string, gdpr_applies:string>>') as unstruct_event_com_fueledanalytics_fueled_consent_preferences_1,
        from_json(unstruct_event_com_fueledanalytics_fueled_cmp_visible_1_0_0, 'array<struct<elapsed_time:string>>') as unstruct_event_com_fueledanalytics_fueled_cmp_visible_1,
        from_json(contexts_com_iab_fueled_spiders_and_robots_1_0_0, 'array<struct<category:string,primaryImpact:string,reason:string,spiderOrRobot:boolean>>') as contexts_com_iab_fueled_spiders_and_robots_1,
        from_json(contexts_com_fueledanalytics_fueled_ua_parser_context_1_0_0, 'array<struct<deviceFamily:string,osFamily:string,osMajor:string,osMinor:string,osPatch:string,osPatchMinor:string,osVersion:string,useragentFamily:string,useragentMajor:string,useragentMinor:string,useragentPatch:string,useragentVersion:string>>') as contexts_com_fueledanalytics_fueled_ua_parser_context_1,
...
select
    ...
    struct(unstruct_event_com_fueledanalytics_fueled_consent_preferences_1[0].basis_for_processing::STRING as basis_for_processing,
        unstruct_event_com_fueledanalytics_fueled_consent_preferences_1[0].consent_scopes::ARRAY<string> as consent_scopes,
        unstruct_event_com_fueledanalytics_fueled_consent_preferences_1[0].consent_url::STRING as consent_url,
        unstruct_event_com_fueledanalytics_fueled_consent_preferences_1[0].consent_version::STRING as consent_version,
        unstruct_event_com_fueledanalytics_fueled_consent_preferences_1[0].domains_applied::ARRAY<string> as domains_applied,
        unstruct_event_com_fueledanalytics_fueled_consent_preferences_1[0].event_type::STRING as event_type,
        unstruct_event_com_fueledanalytics_fueled_consent_preferences_1[0].gdpr_applies::BOOLEAN as gdpr_applies) as unstruct_event_com_fueledanalytics_fueled_consent_preferences_1,
    struct(unstruct_event_com_fueledanalytics_fueled_cmp_visible_1[0].elapsed_time::FLOAT as elapsed_time) as unstruct_event_com_fueledanalytics_fueled_cmp_visible_1,
    array(struct(contexts_com_iab_fueled_spiders_and_robots_1[0].category as category,
        contexts_com_iab_fueled_spiders_and_robots_1[0].primaryImpact as primary_impact,
        contexts_com_iab_fueled_spiders_and_robots_1[0].reason as reason,
        contexts_com_iab_fueled_spiders_and_robots_1[0].spiderOrRobot as spider_or_robot)) as contexts_com_iab_fueled_spiders_and_robots_1,
    array(struct(contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].deviceFamily as device_family,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].osFamily as os_family,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].osMajor as os_major,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].osMinor as os_minor,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].osPatch as os_patch,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].osPatchMinor as os_patch_minor,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].osVersion as os_version,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].useragentFamily as useragent_family,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].useragentMajor as useragent_major,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].useragentMinor as useragent_minor,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].useragentPatch as useragent_patch,
        contexts_com_fueledanalytics_fueled_ua_parser_context_1[0].useragentVersion as useragent_version)) as contexts_com_fueledanalytics_fueled_ua_parser_context_1,
