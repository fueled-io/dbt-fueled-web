...
This context table contains the data generated by the [UA parser enrichment](https://docs.fueled.io/docs/enriching-your-data/available-enrichments/ua-parser-enrichment/).
...
This context table contains the data generated by the [YAUAA enrichment](https://docs.fueled.io/docs/enriching-your-data/available-enrichments/yauaa-enrichment/).
...
The `events` table contains all canonical events generated by [Fueled's](https://fueled.io/) trackers, including web, mobile and server side events.
